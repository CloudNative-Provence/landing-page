export default {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: ['Vos données personnelles peuvent être utilisées pour :'],
      items: [
    ...
    },
    {
      title: 'Sécurité',
      paragraphs: [
        "La sécurité de vos données personnelles est importante pour nous, mais rappelez-vous qu'aucune méthode de transmission sur Internet ou méthode de stockage électronique n'est sûre à 100 %.",
      ],
    },
    {
    ...
    },
    {
      title: 'Modifications',
      paragraphs: [
        'Nous pouvons mettre à jour notre politique de confidentialité de temps en temps. Nous vous informerons de tout changement en publiant la nouvelle politique sur cette page.',
      ],
    },
    {
