...
export default {
  ...
  hero: {
    ...
    subtitle:
      'Explorez le planning complete, comparez les tracks, enregistrez vos sessions favorites, partagez votre agenda personnel et exportez-le dans votre calendrier.',
    date: formatEventDate('fr'),
    venue: getVenueLabel('fr'),
  ...
  selection: {
    title: 'Mon agenda',
    subtitle: 'Vos choix sont sauvegardés dans votre navigateur sur cet apparel.',
