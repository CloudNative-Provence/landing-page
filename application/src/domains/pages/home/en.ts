...
const venueName = getVenueName('en');
const venuePlace = getEventPlace('en');
const venueInfo = getVenueInfo('en');
const venueDescription = venuePlace
  ? `KCD Provence will be held at ${venueName}. The venue sits at ${venueInfo.address}, close to the historic center with direct access to public transport and nearby parking. You'll enjoy modern conference rooms, a sponsor expo area, and plenty of networking spaces throughout the day.`
...
export default {
  metadata: {
    ...
    description: `Join 600+ cloud native professionals on ${eventDate} at ${venueName} for a day of talks, workshops, and networking.`,
  ...
  hero: {
    ...
    subtitle: `Mark your calendars! On ${eventDate}, the Cloud Native community gathers at ${venueName} for a day of exciting talks, networking, and good vibes under the Provençal sun.`,
  ...
  venue: {
    ...
    ctas: [
      {
        text: 'See getting there details',
        href: getLocalizedPagePath('en', 'practical-info', 'getting-there'),
        variant: 'primary',
        icon: 'tabler:route',
      },
      {
        text: 'Find parking',
        href: getLocalizedPagePath('en', 'practical-info', 'parking'),
        variant: 'secondary',
        icon: 'tabler:parking',
      },
      {
        text: 'Find accommodation',
        href: getLocalizedPagePath('en', 'practical-info', 'accommodation'),
        variant: 'secondary',
        icon: 'tabler:bed',
      },
    ],
